...
class AccountAgedPartnerBalanceWebkit(PartnersOpenInvoicesWebkit):
    ...
    def __init__(self, cursor, uid, name, context=None):
        ...
        super(AccountAgedPartnerBalanceWebkit, self).__init__(cursor, uid, name,
                                                            context=context)
...
#         import ipdb;ipdb.set_trace()
        ...
        res = super(AccountAgedPartnerBalanceWebkit, self).set_context(
            objects,
            data,
            ids,
