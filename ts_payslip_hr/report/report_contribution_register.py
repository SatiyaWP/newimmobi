...
report_sxw.report_sxw('report.contribution.register.lines', 'hr.contribution.register', 'ts_payslip_hr/report/report_contribution_register.rml', parser=contribution_register_report)
