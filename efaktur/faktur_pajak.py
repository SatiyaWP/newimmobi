...
class nomor_faktur_pajak(models.Model):
    ...
    amount_untaxed = fields.Float(string='Untaxed Amount', related='invoice_id.amount_untaxed', digits=dp.get_precision('Account'), store=True)
    amount_tax = fields.Float(string='Tax Amount', related='invoice_id.amount_tax', digits=dp.get_precision('Account'), store=True)
